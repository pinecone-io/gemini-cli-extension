---
name: assistant
description: Create, manage, and chat with Pinecone Assistants for document Q&A with citations. Handles all assistant operations - create, upload, sync, chat, context retrieval, and list. Activate when the user asks about creating, managing, or chatting with assistants.
---

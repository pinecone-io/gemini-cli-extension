---
name: pinecone-mcp
description: Reference for the Pinecone MCP server tools. Documents all available tools for integrated indexes. Activate when an agent needs to understand what Pinecone MCP tools are available, how to use them, or what parameters they accept.
---
